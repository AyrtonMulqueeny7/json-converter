...
# ADDED NEW CODE: Reorder columns to put account_type between account_id and account_address/ as specified 
column_order = [
    ...
    'value_timestamp', 'booking_timestamp'
]
...
with pd.ExcelWriter('transaction_data_fixed4.xlsx', engine='openpyxl') as writer:  # Change filename here when needed
